...
public class MainActivity extends Activity implements OnClickListener {
	...
	private void showAlertforLocation(final String picName) {
		...
		alertDialogBuilder
				.setMessage("Shall I Include Location in Picture Name?")
				.setCancelable(false)
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
								if (bytes != null && latitude != 0.0
									...
									Toast.makeText(
											MainActivity.this,
											"No Picture is taken, or Latitude Longitude are not fetched",
											Toast.LENGTH_SHORT).show();
								}
				...
				.setNegativeButton("No", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
						if (bytes != null) {
							...
							Toast.makeText(MainActivity.this,
									"No Picture is was saved", Toast.LENGTH_SHORT)
									.show();
						}
						dialog.cancel();
					}
